...
function bookRoomNow() {    
    ...
    const dates = parseInt(document.getElementById("date").value) || 0; // Added this line
    
    const currentBookingCost = calculateCurrentBookingCost(singleRooms, doubleRooms, tripleRooms, beds, kids, dates);
...
// function calculateCurrentBookingCost(singleRooms, doubleRooms, tripleRooms,dates) {
//     const beds = parseInt(document.getElementById("beds").value) || 0;
//     const kids = parseInt(document.getElementById("childrenInput").value) || 0;
...
//     currentBookingCost =currentBookingCost*dates
...
function calculateCurrentBookingCost(singleRooms, doubleRooms, tripleRooms, beds, kids, dates) {
    const beds = parseInt(document.getElementById("beds").value) || 0;
    const kids = parseInt(document.getElementById("childrenInput").value) || 0;
    const promoCodes = document.getElementById("promoCode").value;
    const dates = parseInt(document.getElementById("date").value) || 0;
...
if (number > 3) {
  // Subtract 3 and multiply the answer by 20
  let result = (number - 3) * 20;
  
  // Display the result with an alert
  alert("The result is: " + result);
} else {
  // If the number is not greater than 3, display a message
  alert("The number is not greater than 3.");
}